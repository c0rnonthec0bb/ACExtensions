...
public extension UIDevice {
    ...
    public var type: Model? {
        ...
        var modelMap : [ String : Model ] = [
            ...
            "iPad8,3"   : .iPadPro11,
            "iPad8,4"   : .iPadPro11,
            "iPad8,5"   : .iPadPro12_9_3rd,
            "iPad8,6"   : .iPadPro12_9_3rd,
            "iPad8,7"   : .iPadPro12_9_3rd,
            "iPad8,8"   : .iPadPro12_9_3rd,
        ]
    ...
    public var processorLevel:ProcessorLevel{
        ...
        case .iPod1, .iPod2, .iPod3, .iPod4, .iPod5, .iPhone4, .iPhone4S, .iPhone5, .iPhone5S, .iPadMini1, .iPadMini2, .iPadMini3, .iPad2, .iPad3, .iPad4, .iPadAir1: // < A8
            return .low
        case .iPhone6, .iPhone6S, .iPhone6plus, .iPhone6Splus, .iPadAir2: // == A8 processor
            return .medium
        default: // > A8 processor
            return .high
        }
    }
}
